...
● Exploit page displays a browser denial/error.`,
  ...
  /**
   * Finding 3: Vulnerable JS Library
   * Risk Score: 6.1 - Using libraries with known vulnerabilities (like jQuery UI) can expose the app to XSS and prototype pollution.
   */
  {
    id: 'finding-3',
...
5. Avoid Hosting Outdated Local Copies
  ...
  /**
   * Finding 4: Missing Rate Limiting & Anti-Automation Controls
   * Risk Score: 5.9 - Vulnerable to automated form abuse, spam, and resource exhaustion.
   */
  {
    id: 'finding-4',
...
7. Log and Monitor Submission Activity
   ...
   * Risk Score: 5.1 - Lacks several browser-side defense-in-depth security headers like HSTS and CSP.
   */
  {
    id: 'finding-5',
...
6. Set a Permissions-Policy
  ...
  /**
   * Finding Low-1: Sub Resource Integrity (SRI) Attribute Missing
   * Risk Score: 3.7 - Missing integrity checks for external scripts could lead to supply-chain attacks if a CDN is compromised.
   */
  {
    id: 'finding-low-1',
...
5. Audit External Dependencies Regularly
  ...
  /**
   * Finding Low-2: Absence of Anti-CSRF Tokens
   * Risk Score: 3.1 - State-changing forms without CSRF protection can be exploited by tricking authenticated users.
   */
  {
    id: 'finding-low-2',
